...
firebase.initializeApp({
  ...
  apiKey: "AIzaSyCRvJ7MPtKbBF5KpH3XWzGjUucDXjya9qI",
  authDomain: "dog-walking-chat.firebaseapp.com",
  databaseURL: "https://dog-walking-chat.firebaseio.com",
  projectId: "dog-walking-chat",
  storageBucket: "dog-walking-chat.appspot.com",
  messagingSenderId: "950467423745"
});
...
window.snapKitInit = () => {
  ...
  const loginParamsObj = {
    clientId: "c8685f58-6517-4cdb-99e9-c4ebf527bc84",
    redirectURI: "http://thisisagreat.club/chat",
    scopeList: [
       "user.bitmoji.avatar",
       "user.display_name",
    ]
